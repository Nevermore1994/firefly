...
bool Connector::open() noexcept {
    ...
    if(info_->isTcpLink()) {
        ...
        while(!setSocketConfig(SOL_SOCKET, SO_RCVBUF, reinterpret_cast<const char *>(&receiveBufferSize),
        ...
        while(!setSocketConfig(SOL_SOCKET, SO_SNDBUF, reinterpret_cast<const char *>(&sendBufferSize),
